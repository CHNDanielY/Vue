...
var hot = Handsontable(document.getElementById('example'), {
  ...
  cells: function (row, column) {
    ...
    if (column === 1) {
      ...
      var isChecked = this.instance.getDataAtCell(
  ...
  modifyData: function (row, column, valueHolder, ioMode) {
    if (this.toPhysicalColumn(column) === 2 && ioMode === 'get') {
      valueHolder.value = getOwnerTeam(
        this.getDataAtCell(this.toVisualRow(row), this.toVisualColumn(1))
      )
    }
  }
})
...
function getData () {
  return [
    ['Task 33', 'Michael', '', 'New', '', '', false, 0],
    ['Task 12', 'Samuel', '', 'New', '', '', false, 0],
    ['Task 96', 'Kate', '', 'Accepted', '', '', false, 0],
    ['Task 16', 'Chris', '', 'Accepted', '', '', false, 0],
    [
      'Task 19',
      'Samuel',
      '',
    ...
    ['Task 04', 'Ben', '', 'Completed', '08/02/2017', '04/04/2017', false, 100],
    ['Task 33', 'Samuel', '', 'Rejected', '', '', false, 0],
    ['Task 79', 'Kate', '', 'Rejected', '', '', false, 0]
  ]
}
